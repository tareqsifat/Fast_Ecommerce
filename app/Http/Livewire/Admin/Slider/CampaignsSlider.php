...
class CampaignsSlider extends Component
{
    ...
    public function delete($id)
    {
        ...
        if (file_exists("uploads/sliders/campaignslider/$delData->image")) {
            File::delete("uploads/sliders/campaignslider/$delData->image");
        }
        Slider::destroy($id);
    ...
    {
        return view('livewire.admin.slider.campaigns-slider', [
            'datas' => Slider::where('name', 'LIKE', "%{$this->searchItem}%")
                ->where('slider_for', 'campaign')
