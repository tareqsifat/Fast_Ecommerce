            ...
            <div class="card-body">
                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $key+1 }} @if($data->ansQuestion->count() > 0)<small class="text-info">({{$data->ansQuestion->count()}})</small>@endif @if($data->notification == 0)<small class="text-info">New</small>@endif</td>
                            <td>{{ $data->email }}</td>
