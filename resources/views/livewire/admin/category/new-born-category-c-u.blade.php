<div wire:ignore.self class="modal fade" id="new_born_Cat_Form" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold text-success" id="exampleModalLabel">New Born Category</h5>
            ...
            <div class="modal-body">
                <div class="card p-3">
                    ...
                    <div class="form-group">
                        <label for="subcategory_id">Sub Sub Category:</label>
                    ...
                    <div class="form-group">
                        <label for="sub_sub_category_id">Baby Category:</label>
