            ...
            <div class="card-header border-0">
                <div class="row mb-5">
                    <div class="col-sm-4 col-md-4">
                        <h4 class="fontweight-bold">On Sell Product Time</h4>
                    </div>
                    <div class="col-sm-4 col-md-4 vartical-align-middle"><input wire:model.lazy="onsellTime" class="form-control" type="datetime-local"></div>
                    <div class="col-sm-4 col-md-4 vartical-align-middle">
                        <input onclick="confirm('Are you sure to save and change it?') || event.stopImmediatePropagation()" wire:click="seveOnsellTime" class="btn btn-sm btn-success" type="submit" value="Save Changes">
                        <input onclick="confirm('Are you sure to save and change it?') || event.stopImmediatePropagation()" wire:click="resetTime" class="btn btn-sm btn-success" type="submit" value="Reset">
                    </div>
                </div>
                <!-- card header -->
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example" class="table table-striped" style="width:100%">
                            <thead>
                                <tr>
                                    <th><sup class="text-info">{{$datas->count()}}</sup> No</th>
                                    <th>Product Code</th>
                                    <th>Title</th>
                                    <th>Brand</th>
                                    <th>Category</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img width="50px" src='{{asset("uploads/products/thumbnails/$data->thumbnail")}}' alt="{{$data->thumbnail}}"></td>
