<form id="product_create_form" wire:submit.prevent="save" enctype="multipart/form-data">
    <div class="row">
        ...
        @livewire('admin.category.before-born-category-c-u')
        ...
        <div class="col-md-8 col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <button class="btn btn-sm btn-info my-2" data-toggle="modal" data-target="#modalspecificationForm">+ Product Specification</button>
        ...
        <div class="col-md-4 col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="brand">Child Category
                            <span wire:loading wire:target="child_category" class="spinner-border spinner-border-sm" role="status">
                                <span class="sr-only">Loading...</span>
                            </span></label> <br>
