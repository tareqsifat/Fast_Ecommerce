                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example" class="table table-striped" style="width:100%">
                            <thead>
                                <tr>
                                    <th>SL/NO <small class="text-info">{{$alldata->count()}}</small></th>
                                    <th>Product Code</th>
                                    <th>Title</th>
                                    <th>Brand</th>
                                    <th>Category</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td data-toggle="tooltip" data-bs-placement="right" title="{{strip_tags($data->description)}}">{!! Str::limit(strip_tags($data->description), 20) !!}</td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{route('admin.products.campaign.edit', $data->id)}}" data-toggle="tooltip" data-bs-placement="top" title="Edit" class="btn btn-default"><i class="fas fa-edit text-warning"></i></a>
