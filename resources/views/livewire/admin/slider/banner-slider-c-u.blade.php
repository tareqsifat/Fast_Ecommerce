    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold text-success" id="exampleModalLabel">Banner Slider</h5>
            ...
            <div class="modal-body">
                <div class="card p-3">
                    ...
                    <div class="form-group">
                        ...
                        <img class="img-thumbnail" height="80px" width="150px" src='{{asset("uploads/sliders/bannerslider/$oldImage")}}'>
                        @endif
                    </div>
                    <div class="form-group">
