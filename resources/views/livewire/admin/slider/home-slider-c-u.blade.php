    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold text-success" id="exampleModalLabel">Slider</h5>
            ...
            <div class="modal-body">
                <div class="card p-3">
                    ...
                    <!-- <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-6">
                                    ...
                                    <input wire:model="subtitle" id="subtitle" type="text" placeholder="Subtitle" class="form-control">
                                </div>
                            </div>
                        </div> -->
                    <!-- sub title  -->
                    ...
                    <div class="form-group">
                        <div class="row">
                            <!-- <div class="col-sm-12 col-md-6">
                                    ...
                                    @if($errors->has('link_text'))<span class="text-danger">{{$errors->first('link_text')}}</span> @endif
                                    <input wire:model="link_text" id="link_text" type="text" placeholder="Link Text" class="form-control">
                                </div> -->
                    ...
                    <div class="form-group">
                        ...
                        <img class="img-thumbnail" height="80px" width="150px" src='{{asset("uploads/sliders/homeslider/$oldImage")}}'>
                        @endif
                    </div>
                    <div class="form-group">
