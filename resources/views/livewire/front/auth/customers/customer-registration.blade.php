                    ...
                    <div class="register-form form-item w-100 " wire:ignore.self>
                        <form class="form-stl" action="#" wire:submit.prevent="signUp" name="frm-login" method="get">
                            ...
                            <fieldset class="wrap-input item-width-in-half left-item ">
                                ...
                                <input wire:model.lazy="phone" type="text" id="phone" name="reg-pass" placeholder="Phone*">
                            </fieldset>
                            <fieldset class="wrap-input item-width-in-half ">
                                <label for="email">Email</label>
                                @if($errors->has('email'))<br> <span class="text_danger">{{$errors->first('email')}}</span> @endif
                                <input wire:model.lazy="email" placeholder="Email" type="email" id="email" name="email">
                            </fieldset>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    ...
                                    <input wire:model.lazy="brithdate" type="date" id="brithdate" name="brithdate">
                                </div>
                                <div class="col-sm-12 col-md-6 col-lg-6">
                            ...
                            <button type="submit" class="btn btn-sign" value="Next" name="register">Next<span wire:loading wire:target="signUp">ing....</span>
                            </button>
