                    ...
                    <div class="login-form form-item form-stl p-5">
                        ...
                        <form name="frm-login" wire:submit.prevent="login">
                            ...
                            <fieldset class="wrap-input">
                                ...
                                <input wire:model.lazy="phone" autocomplete=false type="tel" id="frm-login-uname" name="email" placeholder="Enter your phone">
                            </fieldset>
                            <fieldset class="wrap-input">
                                @if($errors->has('password'))<br> <span class="text-danger">{{$errors->first('password')}}</span> @endif
                                <label for="frm-login-pass">Password:</label>
                                <input wire:model.lazy="password" autocomplete=false type="password" id="frm-login-pass" name="pass" placeholder="************">
                            </fieldset>
                            ...
                            <p class="mt-5 font-weight600 text-align-center">Don't have an account? <a class="color_danger" href="{{route('merchant.register')}}">Sign up</a></p>
