<main id="main" class="main-site">
    ...
    <div class="container">
        ...
        <div class="w-100 row m-auto">
            @if($cateData->subcategories->count()>0)
            <ul class="list-unstyled border_none style-nav-1 categoryImage-slider owl-carousel">
                @foreach($cateData->subcategories as $key=>$uItem)
                <li class="">
                    <div class="wrap-show-advance-info-box style-1 w-100 mb-0 ">
                        <div class="wrap-products">
                            <a href='{{route("category.single", [$cateData->slug, $uItem->slug])}}' title="{{$uItem->name}}">
                                <figure>
                            ...
                            <div class="product-info">
                                <h5 class="font-weight600 text-align-center mt-5 mb-5 text-uppercase"><a class="text_dark" href='{{route("category.single", [$cateData->slug, $uItem->slug])}}'> {{Str::of($uItem->name)->words(2, '')}}</a> </h5>
                            </div>
                        </div>
                    </div>
                </li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 col-md-6 col-lg-6">
                                    <div class="form-group searchBox_select mb-0">
                                        ...
                                        <div class="float-right mx-3 count_by">
