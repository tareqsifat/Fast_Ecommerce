        ...
        <div class="card m-b-30">
            <div class="card-header border-0">
                <button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#modalForm">
                    <a href="{{route('merchent.product.create')}}" class="text-dark font-weight-bold">+ New product</a>
                </button>
                    ...
                    <table id="example" class="table table-striped" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="{{route('merchent.product.edit', $data->id)}}" title="Edit" class="btn btn-default"><i class="fas fa-edit text-warning"></i></a>
                                        <button title="Delete" onclick="confirm('Are you sure to delete it?') || event.stopImmediatePropagation()" wire:click="delete({{$data->id}})" class="btn btn-default"><i class="fas fa-trash text-danger "></i></button>
                                    </div>
                                </td>
                            </tr>
                            @php $i++ @endphp
